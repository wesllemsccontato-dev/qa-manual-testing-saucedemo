# Relatório de Execução de Teste - CT-006

## Identificação do Teste
- ID: CT-006
- Nome: Espaços antes do Usuário 
...
## Objetivo
Validar que o sistema bloqueia o acesso quando ha espaços inceridos depois do identificador (usuário).
...
## Observações
A aplicação apresentou comportamento esperado ao impedir acesso com espaços depois do identificador (usuário).
